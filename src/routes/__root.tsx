...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    meta: [
      ...
      { title: "Texas Bath Solutions | San Antonio Bathroom Remodeling | Free Hassle-Free Estimates" },
      {
        name: "description",
        content:
      ...
      <body>
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1062683162839921&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {children}
